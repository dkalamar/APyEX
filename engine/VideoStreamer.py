...
class VideoStreamer:
    def __init__(self, twitch_url, queueSize=128, resolution='720p', n_frame=10,live=False):
        self.live=live
        self.stopped = False
    ...
    def get_frame(self):
        ...
        return  np.fromstring(raw_image, dtype='uint8').reshape((self.byte_width, self.byte_lenght, 3))
